...
import event9 from "../assets/images/events/9.jpg"
import event10 from "../assets/images/events/10.jpg"
import event11 from "../assets/images/events/11.jpg"
import event12 from "../assets/images/events/12.jpg"
                    ...
                    <div className="col-lg-12 mt-4 pt-2">
                        <ul className="nav nav-pills nav-justified flex-column flex-sm-row bg-transparent mb-0">
                            <li className="nav-item">
                                <Link className={activeIndex === 1 ? "nav-link rounded active" : "nav-link rounded"} id="pills-first-tab" to="#" onClick={()=>setActiveIndex(1)}>
                            ...
                            <li className="nav-item">
                                <Link className={activeIndex === 2 ? "nav-link rounded active" : "nav-link rounded"} id="pills-second-tab" to="#" onClick={()=>setActiveIndex(2)}>
                                    <div className="text-center p-2">
                            ...
                            <li className="nav-item">
                                <Link className={activeIndex === 3 ? "nav-link rounded active" : "nav-link rounded"} id="pills-third-tab" to="#" onClick={()=>setActiveIndex(3)}>
                                    <div className="text-center p-2">
                            ...
                            <li className="nav-item">
                                <Link className={activeIndex === 4 ? "nav-link rounded active" : "nav-link rounded"} id="pills-fourth-tab" to="#" onClick={()=>setActiveIndex(4)}>
                                    <div className="text-center p-2">
                                                        ...
                                                        <tr key={index}>
                                                            ...
                                                            <td className="px-3 py-5" style={{minWidth:'550px'}}>
                                                                <div className="d-flex align-items-center">
                                                                    <img src={item.image} className="avatar avatar-medium rounded-pill shadow-lg float-start" alt=""/>
                                                                    <div className="ms-3">
                                                                        <h6>{item.title}</h6>
