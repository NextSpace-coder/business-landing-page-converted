...
import crypto from "../assets/images/crypto/apps.png"
    ...
    return(
        ...
        <div className="row align-items-center">
            <div className="col-lg-5 col-md-5 col-12">
                <img src={crypto} className="img-fluid" alt=""/>
            </div>
            ...
            <div className="col-lg-7 col-md-7 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                <div className="section-title ms-lg-5">
                    ...
                    <div className="my-4">
                        <Link to="#" className="btn btn-lg btn-dark mt-2 me-2"><BsApple/> App Store</Link>
                        <Link to="#" className="btn btn-lg btn-dark mt-2">Play Store <FaGooglePlay/></Link>
                    </div>
