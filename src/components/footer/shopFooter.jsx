                                ...
                                <div className="row">
                                    ...
                                    <div className="col-lg-4 col-md-4 col-12">
                                        <ul className="list-unstyled footer-list">
                                            <li><Link to="/index-fashion" className="text-foot d-flex align-items-center"><IoIosArrowForward className="me-1"/> Men</Link></li>
                                            <li><Link to="/index-fashion" className="text-foot d-flex align-items-center"><IoIosArrowForward className="me-1"/> Jackets & Coats </Link></li>
                                            <li><Link to="/index-fashion" className="text-foot d-flex align-items-center"><IoIosArrowForward className="me-1"/> Jeans </Link></li>
                                            <li><Link to="/index-fashion" className="text-foot d-flex align-items-center"><IoIosArrowForward className="me-1"/>  Loungewear </Link></li>
                                            <li><Link to="/index-fashion" className="text-foot d-flex align-items-center"><IoIosArrowForward className="me-1"/> Polo shirts </Link></li>
                                            <li><Link to="/index-fashion" className="text-foot d-flex align-items-center"><IoIosArrowForward className="me-1"/> Shirts</Link></li>
                                        </ul>
                                    </div>
                                    
                                    <div className="col-lg-4 col-md-4 col-12 mt-2 mt-sm-0">
                                        <ul className="list-unstyled footer-list">
                                            <li><Link to="/index-fashion" className="text-foot d-flex align-items-center"><IoIosArrowForward className="me-1"/> Shorts </Link></li>
                                            <li><Link to="/index-fashion" className="text-foot d-flex align-items-center"><IoIosArrowForward className="me-1"/> Suits Swimwear </Link></li>
                                            <li><Link to="/index-fashion" className="text-foot d-flex align-items-center"><IoIosArrowForward className="me-1"/> T-shirts </Link></li>
                                            <li><Link to="/index-fashion" className="text-foot d-flex align-items-center"><IoIosArrowForward className="me-1"/> Tracksuits </Link></li>
                                            <li><Link to="/index-fashion" className="text-foot d-flex align-items-center"><IoIosArrowForward className="me-1"/> Trousers</Link></li>
                                            <li><Link to="/index-fashion" className="text-foot d-flex align-items-center"><IoIosArrowForward className="me-1"/> Shirts</Link></li>
                                        </ul>
                                    </div>
                                    ...
                                    <div className="col-lg-4 col-md-4 col-12 mt-2 mt-sm-0">
                                        <ul className="list-unstyled footer-list">
                                            <li><Link to="/index-fashion" className="text-foot d-flex align-items-center"><IoIosArrowForward className="me-1"/> My account </Link></li>
                                            <li><Link to="/index-fashion" className="text-foot d-flex align-items-center"><IoIosArrowForward className="me-1"/> Order History </Link></li>
                                            <li><Link to="/index-fashion" className="text-foot d-flex align-items-center"><IoIosArrowForward className="me-1"/> Wish List </Link></li>
                                            <li><Link to="/index-fashion" className="text-foot d-flex align-items-center"><IoIosArrowForward className="me-1"/> Newsletter</Link></li>
                                            <li><Link to="/index-fashion" className="text-foot d-flex align-items-center"><IoIosArrowForward className="me-1"/> Affiliate</Link></li>
                                            <li><Link to="/index-fashion" className="text-foot d-flex align-items-center"><IoIosArrowForward className="me-1"/> Returns</Link></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
