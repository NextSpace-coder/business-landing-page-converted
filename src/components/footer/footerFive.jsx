                        ...
                        <div className="footer-py-60">
                            <div className="row">
                                ...
                                <div className="col-lg-2 col-md-4 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                                    ...
                                    <ul className="list-unstyled footer-list mt-4">
                                        <li><Link to="/" className="text-foot d-flex align-items-center"><IoIosArrowForward className="me-1"/> Terms of Services</Link></li>
                                        <li><Link to="/" className="text-foot d-flex align-items-center"><IoIosArrowForward className="me-1"/> Privacy Policy</Link></li>
                                        ...
                                        <li><Link to="/" className="text-foot d-flex align-items-center"><IoIosArrowForward className="me-1"/> Changelog</Link></li>
                                ...
                                <div className="col-lg-4 col-md-4 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                                    ...
                                    <small className="d-block">Are you developer ? <Link to="#" className="text-foot fw-medium">Learn More<FiArrowRight/></Link></small>

                                    <img src={logoIcon} height="100" className="mt-4" alt=""/>
                                </div>
                            </div>
                        </div>
                    </div>
