                        ...
                        <div className="row align-items-center">
                                ...
                                <div className="section-title">
                                    ...
                                    <TbMailStar className="display-4 text-white title-dark"/>
                                        <div className="flex-1 ms-md-4 ms-3">
                                            ...
                                            <p className="text-white-50 mb-0">Build responsive, mobile-first projects on the web with the world's most popular front-end component library.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-md-4 mt-4 mt-sm-0">
                                <div className="text-md-end ms-5 ms-sm-0">
                                    <Link to="#" className="btn btn-primary" onClick={handleShow}>Contact Now</Link>
                                </div>
                            </div>
                        </div>
                    </div>
