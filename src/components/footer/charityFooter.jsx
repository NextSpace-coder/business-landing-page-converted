                                    ...
                                    <div className="section-title">
                                        <div className="d-flex align-items-center">
                                            ...
                                            <div className="flex-1 ms-3">
                                                <Link to="tel:+152534-468-854" className="text-light title-dark mb-0 h5">+152 534-468-854</Link>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="col-lg-6 col-12">
                                    <div className="section-title">
                                        <div className="d-flex align-items-center">
                                            ...
                                            <div className="flex-1 ms-3">
                                                <Link to="mailto:contact@example.com" className="text-light title-dark mb-0 h5">contact@example.com</Link>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="row align-items-center justify-content-between">
                                ...
                                <div className="col-lg-7 col-md-6 col-sm-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                                    <ul className="list-unstyled footer-list terms-service mb-0 text-sm-start">
                                        <li className="list-inline-item mb-0"><Link to="/page-aboutus" className="text-foot me-2">About us</Link></li>
                                        <li className="list-inline-item mb-0"><Link to="#" className="text-foot me-2">Terms</Link></li>
                                        <li className="list-inline-item mb-0"><Link to="/page-faqs" className="text-foot me-2">FAQs</Link></li>
                                        <li className="list-inline-item mb-0"><Link to="/page-contact" className="text-foot">Contact</Link></li>
                                    </ul>
                                </div>
