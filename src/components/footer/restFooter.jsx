...
import bg from '../../assets/images/bg/rest-footer.jpg'
                                    ...
                                    <div className="col-12 text-center">
                                        ...
                                        <div className="content mt-4 pt-2">
                                            ...
                                            <ul className="list-unstyled footer-list mb-0">
                                                <li className="list-inline-item mx-2"><Link to="tel:+152534-468-854" className="text-foot">+152 534-468-854</Link></li>
                                                <li className="list-inline-item mx-2"><Link to="mailto:contact@example.com" className="text-foot">contact@example.com</Link></li>
                                            </ul>
                        ...
                        <div className="row align-items-center">
                            <div className="col-sm-6">
                                <div className="text-sm-start text-center">
                                    <p className="mb-0">{new Date().getFullYear()}© Starty. Design & Develop with <i className="mdi mdi-heart text-danger"></i> by <Link to="https://shreethemes.in/" target="_blank" className="text-reset">Shreethemes</Link>.</p>
                                </div>
                            </div>
