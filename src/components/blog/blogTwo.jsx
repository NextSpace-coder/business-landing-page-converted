...
import image1 from '../../assets/images/blog/img01.jpg'
import client1 from '../../assets/images/client/04.jpg'
        ...
        <div className="row justify-content-center">
                ...
                <div className="card blog blog-image blog-primary shadow rounded overflow-hidden">
                    <div className="card-img">
                        ...
                        <div className="position-absolute top-0 start-0 mt-3 ms-4">
                            <Link to="#" className="badge text-bg-light">Finance</Link>
                        </div>
                    </div>
                    <div className="content px-4">
                        <Link to="/blog-detail-one" className="h5 title d-block mb-0 text-white title-dark">How to Get a Successful Ad for Your Business</Link>

                        <div className="d-flex author align-items-center mt-2">
                            <img src={client1} className="avatar avatar-md-sm rounded-pill" alt=""/>
                            <div className="ms-2">
            ...
            <div className="col-lg-4 col-md-6 mt-4 pt-2">
                <div className="card blog blog-primary shadow rounded overflow-hidden">
                    ...
                    <div className="card-body content">
                        <Link to="/blog-detail-three" className="h5 title text-dark d-block mb-0">Building Your Corporate Identity from Starty</Link>
            ...
            <div className="col-lg-4 col-md-6 mt-4 pt-2">
                <div className="card blog blog-primary shadow rounded overflow-hidden">
                    ...
                    <div className="card-body content">
                        <Link to="/blog-detail-three" className="h5 title text-dark d-block mb-0">Stuck in a Financial Debt? Here’s an Easy Way Out</Link>
                        <p className="text-muted mt-2 mb-2">The most well-known dummy text is the 'Lorem Ipsum', in the 16th century.</p>
                        <Link to="/blog-detail-three" className="link text-dark">Read More <FiArrowRight className="ms-1 align-middle"/></Link>
                    </div>
                </div>
