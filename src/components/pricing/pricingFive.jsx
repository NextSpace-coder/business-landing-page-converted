        ...
        <div className="row">
            <div className="col-lg-4 col-md-6 mt-4 pt-2">
                <div className="card pricing text-center border-0 rounded py-5">
                    ...
                    <div className="mt-5">
                        <Link to="#" className="btn btn-lg btn-primary">Free</Link>
                    </div>
                </div>
            </div>
            ...
            <div className="col-lg-4 col-md-6 mt-4 pt-2">
                <div className="card pricing bg-primary bg-gradient text-center border-0 rounded py-5">
                    ...
                    <div className="mt-5">
                        <Link to="#" className="btn btn-lg btn-light">Start Now</Link>
                    </div>
                </div>
            </div>
            ...
            <div className="col-lg-4 col-md-6 mt-4 pt-2">
                <div className="card pricing text-center border-0 rounded py-5">
                    ...
                    <div className="mt-5">
                        <Link to="#" className="btn btn-lg btn-primary">Update Now</Link>
                    </div>
                </div>
            </div>
        </div>
