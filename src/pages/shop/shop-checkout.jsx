                ...
                <div className="row mt-5 justify-content-center">
                    <div className="col-12">
                        <div className="title-heading text-center">
                            <small className="text-white-50 mb-1 fw-medium text-uppercase mx-auto">Shop Checkout</small>
                            <h5 className="heading fw-semibold mb-0 page-heading text-white title-dark">Checkout</h5>
                        </div>
                    </div>
                </div>
            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-5 col-lg-4 order-md-last">
                        <div className="card rounded shadow p-4 border-0 sticky-bar">
                            ...
                            <form className="needs-validation">
                                <div className="row g-3">
                                    <div className="col-sm-6">
                                        ...
                                        <input type="text" className="form-control" id="firstName" placeholder="First Name" defaultValue=""
                                            required/>
                                    ...
                                    <div className="col-sm-6">
                                        ...
                                        <input type="text" className="form-control" id="lastName" placeholder="Last Name" defaultValue=""
                                            required/>
                                        <div className="invalid-feedback">
