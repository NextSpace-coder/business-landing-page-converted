    ...
    const pricingData = [
        {
            ...
            payaments:'One day payments',
            features:['Number of People 01 Person','Unlimited Projects','Club Access Unlimited Access','Class Access Fitness Classes','Enhanced Security'],
            amount:'5.00',
            btnClass:'btn btn-lg btn-soft-primary'
        },
        {
            title:'1 MONTH PLAN',
            payaments:'Monthly payments',
            features:['Number of People 01 Person','Unlimited Projects','Club Access Unlimited Access','Class Access Fitness Classes','Enhanced Security'],
            amount:'45.00',
                        ...
                        <div className="col-lg-4 col-md-6 col-12 mt-4 pt-2" key={index}>
                            <div className="card pricing text-center border-0 rounded shadow overflow-hidden">
                                ...
                                <div className="px-4 pb-5 pt-4 bg-white">
                                    ...
                                    <Link to="#" className={item.btnClass}>Subscribe Now</Link>
                                </div>
                            </div>
                        </div>
                        )
