            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-6">
                        <img src={image1} className="rounded shadow img-fluid" alt=""/>
                        <img src={image2} className="rounded shadow img-fluid mt-4" alt=""/>
                        <img src={image3} className="rounded shadow img-fluid mt-4" alt=""/>
                    </div>
