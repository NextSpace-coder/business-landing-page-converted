...
import bg1 from "../../assets/images/bg/port04.jpg"

import NavbarTwo from "../../components/navbar/navbarTwo";
import FooterSeven from "../../components/footer/footerSeven";
import ScrollTop from "../../components/scrollTop";
import ModernPortfolioTwo from "../../components/modernPortfolioTwo";
...
export default function ModernSix(){
    return(
        ...
        <section className="section">
           <ModernPortfolioTwo gridClass="row row-cols-md-2 row-cols-lg-6 mt-4 pt-2"/>
        </section>
        <FooterSeven/>
        <ScrollTop/>
        </>
