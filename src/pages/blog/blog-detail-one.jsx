...
import image2 from "../../assets/images/blog/single02.jpg"
                    ...
                    <div className="col-lg-9">
                        <div className="title-heading">
                            <ul className="list-inline">
                                <li className="list-inline-item"><AiOutlineUser className="mb-0 me-1 text-dark h5"/><Link to="#" className="text-primary h6"> Mr. Donald Ruffy</Link></li>
        ...
        <section className="section">
                    ...
                    <div className="col-12">
                        <div className="card rounded overflow-hidden">
                            ...
                            <div className="position-absolute bottom-0 start-0 mb-3 ms-4">
                                <Link to="#" className="badge text-bg-primary me-1">Finance</Link>
                                <Link to="#" className="badge text-bg-primary">Marketing</Link>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div className="col-md-1 d-md-block d-none">
                                <div className="sidebar sticky-bar">
                                    <ul className="list-unstyled align-items-center social-icon social mb-0">
                                        <li><Link to="#" className="rounded"><FaFacebookF/></Link></li>
                                        <li><Link to="#" className="rounded mt-1"><AiOutlineInstagram/></Link></li>
                                        <li><Link to="#" className="rounded mt-1"><AiOutlineTwitter/></Link></li>
                                        <li><Link to="#" className="rounded mt-1"><AiFillLinkedin/></Link></li>
                                        <li><Link to="#" className="rounded mt-1"><AiOutlineDribbble/></Link></li>
                                    </ul>
                                </div>
                            </div>
            ...
            <div className="container mt-100 mt-60">
                <div className="row">
                    <div className="col-12">
                        <div className="card rounded overflow-hidden">
                            <img src={image2} className="img-fluid rounded shadow" alt=""/>
                            ...
                            <div className="col-lg-4 col-md-6 mt-4 pt-2" key={index}>
                                <div className="card blog blog-primary shadow rounded overflow-hidden">
                                    ...
                                    <div className="card-body content">
                                        <Link to="/blog-detail-one" className="h5 title text-dark d-block mb-0">{item.title}</Link>
                                        <p className="text-muted mt-2 mb-2">{item.desc}</p>
                                        <Link to="/blog-detail-one" className="link text-dark">Read More <FiArrowRight className="ms-1 align-middle"/></Link>
                                    </div>
                                </div>
                            </div>
                        )
