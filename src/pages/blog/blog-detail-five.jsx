...
import bg1 from "../../assets/images/blog/single01.jpg"
import image from "../../assets/images/blog/single05.jpg"
...
export default function BlogDetailFive(){
    return(
        ...
        <section className="bg-half-170" style={{backgroundImage:`url(${bg1})`}}>
                        ...
                        <div className="features-absolute shadow bg-white p-4 rounded">
                            <div className="row">
                                <div className="col-12">
                                    ...
                                    <Link to="#" className="badge text-bg-primary me-1">Tech</Link>
                                    <Link to="#" className="badge text-bg-primary me-1">Technology</Link>
                                    <Link to="#" className="badge text-bg-primary me-1">Future</Link>
                                    <div className="card mt-4 rounded overflow-hidden">
                                        <img src={image} className="img-fluid rounded shadow" alt=""/>
