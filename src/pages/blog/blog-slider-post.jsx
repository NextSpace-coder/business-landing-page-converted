...
import slide1 from "../../assets/images/blog/slide01.jpg" 
import slide2 from "../../assets/images/blog/slide02.jpg" 
import slide3 from "../../assets/images/blog/slide03.jpg" 
                        ...
                        <div className="title-heading text-center">
                            ...
                            <ul className="list-inline text-center mb-0">
                                ...
                                <li className="list-inline-item mx-4 mt-4">
                                    ...
                                    <span className="text-white title-dark">13th Sep 2021</span>
                                </li>
            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-8 col-md-7">
                        <div className="home-slider card border-0 shadow rounded overflow-hidden">
