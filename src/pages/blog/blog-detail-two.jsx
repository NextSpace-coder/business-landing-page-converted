...
import blog1 from "../../assets/images/blog/single03.jpg"
import blog2 from "../../assets/images/blog/img04.jpg"
                ...
                <div className="row justify-content-center">
                    <div className="col-lg-10">
                        <div className="title-heading">
                            <h4 className="heading fw-semibold">{data?.title? data?.title : 'These striking photos capture the future of human flight'}</h4>

                            <div className="d-flex mt-4 pb-4 align-items-center justify-content-between">
                                <div className="d-flex author align-items-center">
                                    <img src={data?.client ? data.client : client1} className="avatar avatar-md-sm rounded-pill" alt=""/>
                                    <div className="ms-2">
                                        <h6 className="user d-block mb-0"><Link to="#" className="text-dark">{data?.name ? data.name : 'Cristino Murphy'}</Link></h6>
                            ...
                            <ul className="list-inline d-flex pt-4 mb-0 border-top justify-content-between">
                                <li className="list-inline-item text-muted h6"><AiOutlineCalendar className="me-1 h5 text-dark"/> {data?.date ? data.date : '19th June 2021'}</li>
                                <li className="list-inline-item text-muted h6"><AiOutlineClockCircle className="me-1 h5 text-dark"/> 10 min read</li>
                            </ul>
                        </div>

                        <div className="mt-5">
                            <img src={data?.image ? data.image : blog1} className="img-fluid rounded shadow" alt=""/>
                        </div>
                        ...
                        <div className="row align-items-center mt-5">
                            <div className="col-md-5">
                                <div className="position-relative">
                                    <img src={blog2} className="img-fluid rounded shadow" alt=""/>
