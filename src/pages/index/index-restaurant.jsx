...
import bg1 from "../../assets/images/bg/rest01.jpg"
import bg2 from "../../assets/images/bg/rest02.jpg"
import bg3 from "../../assets/images/bg/rest03.jpg"
import about from "../../assets/images/bg/rest-about.png"
import manu from "../../assets/images/bg/rest-menu.jpg"
import manu2 from "../../assets/images/bg/rest-menu.png"
import service1 from "../../assets/images/icon/resto/dish.svg"
import service2 from "../../assets/images/icon/resto/fast-food.svg"
import service3 from "../../assets/images/icon/resto/take-away.svg"
import service4 from "../../assets/images/icon/resto/tray.svg"
import cta from "../../assets/images/bg/rest-cta.jpg"
...
export default function IndexRestaurant(){
    ...
    return(
                            ...
                            <div className="row justify-content-center">
                                <div className="col-lg-12 text-center">
                                    <div className="title-heading mt-4">
                                        ...
                                        <div className="mt-4 pt-2 animated fadeInUpBig animation-delay-7">
                                            <Link to="#" className="btn btn-font-sm btn-pills-0 btn-lg btn-light text-uppercase mt-2">View more</Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="col-lg-9 text-center">
                        <div className="section-title mb-4">
                            ...
                            <div className="mt-4 pt-2">
                                <Link to="/page-aboutus" className="btn btn-font-sm btn-pills-0 btn-lg btn-primary text-uppercase mt-2">Read more</Link>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section className="section pt-5 bg-white" style={{backgroundImage:`url(${manu2})`, backgroundPosition:'center'}}>
                    ...
                    {serviceData.map((item, index) =>{
                        ...
                        <div className="col-lg-3 col-md-6 mt-4 pt-2" key={index}>
                            <div className="features feature-primary text-center border-0">
                                <img src={item.image} className="avatar avatar-md-md rounded-circle p-4 shadow-md" alt=""/>
    
                                <div className="content mt-4">
                                    <Link to="#" className="title fw-semibold h5 text-dark">{item.title}</Link>
        ...
        <section className="position-relative overflow-hidden w-100" id="book-table" data-jarallax='{"speed": 0.5}'>
            <Parallax
                blur={{ min: 0, max: 0}}
                bgImage={cta}
                bgImageAlt="the dog"
