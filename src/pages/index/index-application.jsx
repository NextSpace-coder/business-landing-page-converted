...
export default function IndexApplication(){
    ...
    return(
        ...
        <section className="bg-half-170 pb-lg-0 pb-md-4 d-table w-100" style={{backgroundImage:`url(${backgroundImage})`, backgroundRepeat:'no-repeat', backgroundPosition:'center'}}>
