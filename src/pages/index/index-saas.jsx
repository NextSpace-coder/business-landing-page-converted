...
import {PiGoogleDriveLogoBold, BiCommentDetail, LuHistory, TbFidgetSpinner,AiOutlineGithub, BiCog, FiPlay, AiOutlineCheckCircle, MdKeyboardArrowRight} from "../../assets/icons/vander"
                    ...
                    <div className="col-lg-12 text-center mt-0 mt-md-5 pt-0 pt-md-5">
                        <div className="title-heading margin-top-100">
                            ...
                            <div className="mt-4 pt-2">
                                <Link to="#" onClick={() => setOpen(true)} className="btn btn-lg btn-pills btn-primary lightbox"><FiPlay className="me-2"/>Watch now</Link>
                            </div>
                            <ModalVideo
                                channel="youtube"
                ...
                <div className="row align-items-center">
                    ...
                    <div className="col-lg-7 col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                        <div className="section-title ms-lg-5">
                            ...
                            <Link to="#" className="mt-3 h6 text-primary">Find Out More <MdKeyboardArrowRight className="align-middle"/></Link>
                        </div>
                    </div>
                </div>
            </div> 
