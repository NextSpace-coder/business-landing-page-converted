...
import bg1 from "../../assets/images/bg/crypto.png"
import image1 from "../../assets/images/crypto/hand-with-mobile.png"
import wallet from "../../assets/images/crypto/wallet.png"
...
import {BsPhone, TbCube,FiAirplay, BsVectorPen, FiArrowRight, AiOutlineCheckCircle} from "../../assets/icons/vander"
...
export default function IndexCrypto(){
    ...
    return(
        ...
        <section className="section bg-light" style={{backgroundImage:`url(${wallet})`}}>
            <div className="container">
                                ...
                                <tbody>
                                    {cryptoPricing.map((item,index) =>{
                                        ...
                                        <tr key={index}>
                                            ...
                                            <td className="p-3 text-end"><Link to="#" className="btn btn-sm btn-soft-primary">Trade</Link></td>
                                        </tr>
                                        )
                                    })}
                                </tbody>
